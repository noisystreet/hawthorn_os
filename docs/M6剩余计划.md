...
> 本文档是 [M6_PLAN.md](./M6计划.md) 的补充，聚焦 M6 已完成 MMU 启用后的剩余任务。
...
- [M6_PLAN.md](./M6计划.md) — M6 总体计划（含已完成部分）
- [M6_MMU调试日志.md](./M6_MMU调试日志.md) — MMU 调试与修复记录
- [PR与议题计划.md](./PR与议题计划.md) — M7 IPC 规划
- [内核.md](./内核.md) — 内核设计文档
